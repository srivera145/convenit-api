 ...
 * @param {Object} opts optional settings with sig { min_length, max_length, regex }
 */
...
function getRandomProfileUrl() {
    ...
    return `https://convenit-api.onrender.com/img/${img}`
}

// Hot-fix, better mechanism later on
function ensureCorrectImage(url) {
    if (!url || !url.startsWith('https://convenit-api.onrender.com/img/')) {
